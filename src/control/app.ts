...
export class App {
    ...
    constructor(canvas: HTMLCanvasElement) {
        ...
        this.canvas.addEventListener("mousemove", (event) => this.handleMouseMoveEvent(event));
    }
    ...
    run = () => {
        ...
        this.renderer.render(this.scene.getCamera(), this.scene.getTriangles(), this.scene.triangleCount);
