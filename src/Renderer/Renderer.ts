...
import { CameraComponent } from "../model/Camera";
import { TriangleComponent } from "../model/Triangle";
...
export class Renderer {
    ...
    createAssets = async () => {
        ...
        await this.material.initialize(this.device, "dist/img/miot.png");
    };
    ...
    render = async (camera: CameraComponent, triangleObjects: Float32Array, triangleCount: number) => {
        if (!this.device) {
